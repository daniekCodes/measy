...
class Appointment(Base):
    ...
    location_id: int = Column(Integer, ForeignKey('location.id'), nullable=False)
    title: str = Column(String, nullable=False)
    description: str = Column(String, nullable=True)
    start_datetime: datetime = Column(DateTime, nullable=True)
    end_datetime: datetime = Column(DateTime, nullable=True)
